...
export class QwcChat extends LitElement {
    ...
    // FIXME's related to image upload:
    // after submitting a message with images, remove the images from the upload component
    // show progress bar after submitting a message with an image
    ...
    render() {
        ...
        return html`
            ...
            <!-- FIXME: support for uploading images, when we resolve the upload reliability problem -->
...
<!--            <vaadin-upload .maxFiles="1" id="upload-image" .nodrop="${false}"></vaadin-upload>-->
    ...
    _handleSendChat(e) {
        ...
        // FIXME: This adds support for images, but it's not working reliably
        // for images over 100 kB, even if I use a WebSocketFrameSizeCustomizer on the server
