        ...
        return html`
            ...
            <div class="explanation">
                <ol>
                    ...
                    <li>The application asks the LLM to create a SQL query that retrieves the relevant data from thd database.</li>
                    <li>The application looks executes the SQL query.</li>
